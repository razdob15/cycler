...
public class HeartUtil {
    private static final String TAG = "HeartUtil";
    ...
    public HeartUtil(ImageView heartWhite, ImageView heartRed) {
    ...
    public void toggleLike() {
        ...
        if (heartRed.getVisibility() == View.VISIBLE) {
            ...
            ObjectAnimator scaleDownX = ObjectAnimator.ofFloat(heartRed, "scaleX", 10.1f, 1f);
            scaleDownX.setDuration(300);
